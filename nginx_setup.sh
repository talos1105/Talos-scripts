...
log_info()    { echo -e "[$(_log_ts)] ${BLUE}[INFO]${NC}: $*"; }
log_done()    { echo -e "[$(_log_ts)] ${GREEN}[DONE]${NC}: $*"; }
log_warn()    { echo -e "[$(_log_ts)] ${YELLOW}[WARN]${NC}: $*"; }
log_error()   { echo -e "[$(_log_ts)] ${RED}[ERROR]${NC}: $*" >&2; }
log_section() {
    echo ""
    echo -e "${BOLD}══════════════════════════════════════${NC}"
    echo -e "${BOLD}  $*${NC}"
